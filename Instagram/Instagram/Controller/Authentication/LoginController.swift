...
final class LoginController: UIViewController {
    ...
    private let forgotPasswordButton: UIButton = {
        ...
        attributedTitle.append(NSAttributedString(string: "Get help sighing in", attributes: boldAtts))
    ...
    private let dontHaveAccountButton: UIButton = {
        ...
        let boldAtts: [NSAttributedString.Key: Any] = [.foregroundColor: UIColor(white: 1, alpha: 0.7),
                                                       .font: UIFont.boldSystemFont(ofSize: 16)]
        attributedTitle.append(NSAttributedString(string: "Sigh Up", attributes: boldAtts))
        button.setAttributedTitle(attributedTitle, for: .normal)
        return button
    }()
